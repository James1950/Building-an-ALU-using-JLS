...
public class Sample16BitALUTest {
  ...
  public void testSubu() {
    setPinUnsigned("InputA", 55);
    setPinUnsigned("InputB", 5);
    setPinUnsigned("Op", OpCodes.SUBU);
    run();
    Assert.assertEquals("Subtraction Output", (55 - 5) % 65536, readPinUnsigned("Output"));
    
    //overflow 
    Assert.assertEquals("Subtraciton Overflow", false, readPin("Overflow"));
  }
  ...
  public void testAddition2() {
    setPinSigned("InputA", -3);
    setPinSigned("InputB", 5);
    setPinUnsigned("Op", OpCodes.ADD);
    run();
    Assert.assertEquals("Addition Output", -3 + 5, readPinSigned("Output"));
    Assert.assertEquals("Additional Overflow", false, readPin("Overflow"));
  }

  @Test
  public void testAddition3() {
    setPinSigned("InputA", 1);
    setPinSigned("InputB", 32767);
    setPinUnsigned("Op", OpCodes.ADD);
    run();
    Assert.assertEquals("Addition Output", -32767 - 1, readPinSigned("Output"));
    Assert.assertEquals("Assitional Overflow", true, readPin("Overflow"));
  }
  ...
  @Test
  public void testSubtration2() {
   setPinSigned("InputA", -5);
   setPinSigned("InputB", 6);
   setPinUnsigned("Op", OpCodes.SUB);
   run();
   Assert.assertEquals("Subtraction Output", -5 - 6, readPinSigned("Output"));
   Assert.assertEquals("Subtraction Overflow", false, readPin("Overflow"));
  }
  ...
  public void testSubtraction3() {
   ...
   setPinSigned("InputB", -32768);
   setPinUnsigned("Op", OpCodes.SUB);
   run();
   Assert.assertEquals("Subtraction Output", 32767 -32768, readPinSigned("Output"));
  ...
  public void testLUI() {
    ...
    run();
    Assert.assertEquals("LUI Output", 256, readPinSigned("Output"));
  }
  ...
  @Test 
  public void testOr() {
    verifyLogic("or", OpCodes.OR, 0x1, 0x0F0F, (a, b) -> a | b);
  }
